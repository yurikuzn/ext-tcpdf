...
```
node build --copy; site/vendor/bin/phpunit site/tests/unit/Espo/Modules/Tcpdf
```
...
```
(cd site && vendor/bin/phpunit tests/integration/Espo/Modules/Tcpdf)
```
...
* `site/custom/`
* `site/client/custom/`
* `site/tests/unit/Espo/Modules/Tcpdf`
* `site/tests/integration/Espo/Modules/Tcpdf`
...
2. Set *bundled* and *jsTranspiled* to true in `src/files/custom/Espo/Modules/Tcpdf/Resources/module.json`.
3. Add `src/files/custom/Espo/Modules/Tcpdf/Resources/metadata/app/client.json`
    ```json
    {
        "scriptList": [
            "__APPEND__",
            "client/custom/modules/tcpdf/lib/init.js"
        ]
    }
    ```
